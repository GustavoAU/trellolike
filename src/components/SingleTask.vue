...
<template>
  <div
    class="SingleTask text-gray-800 w-full bg-primary-dark p-2 mb-5 mt-10 rounded-xl shadow-md transform hover:shadow-lg transition duration-300 ease-in-out"
  >
    <ElementHeader
